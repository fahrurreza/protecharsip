  ...
  <div v-if="!loading">
    <div class="box box-info" v-bind:class="{ 'collapsed-box': !show }">
      ...
      <form class="form-horizontal">
          <div class="box-body">
            <div class="form-group" v-bind:class="{ 'has-error': hasError.rak_name }">
              <label class="col-sm-3 control-label">Rak Name*</label>
              <div class="col-sm-7">
                <input v-model="form.rak_name" type="text" name="label" class="form-control" id="form_label">
                <span v-if="error.rak_name" class="help-block">@{{ error.rak_name }}</span>
              </div>
            </div>
              ...
              <table id="datatable" class="table table-bordered table-striped">
                ...
                <tbody>
                  <tr>
                    ...
                    <td><input type="text" id="rak_name" v-on:keyup="this.search('rak_name')"></td>
...
<script src="assets/js/page/rak.js"></script>
